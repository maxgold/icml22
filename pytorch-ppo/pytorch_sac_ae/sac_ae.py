...
from pytorch_sac_ae.encoder import make_encoder
from pytorch_sac_ae.decoder import make_decoder
...
class StateCritic(nn.Module):
    ...
    def __init__(
        ...
        self.Q1 = QFunction(
            obs_shape, action_shape[0], hidden_dim
        )
        self.Q2 = QFunction(
            obs_shape, action_shape[0], hidden_dim
        )
...
class StateSacAeAgent(object):
    ...
    def __init__(
        ...
        self.actor = StateActor(
            input_dim, action_shape, hidden_dim,
        ...
        self.critic_target = StateCritic(
            input_dim, action_shape, hidden_dim
        ).to(device)
